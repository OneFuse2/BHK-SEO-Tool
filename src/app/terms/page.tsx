    ...
    <div className="bg-background">
      <div className="container mx-auto px-4 py-12 md:py-20">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-5xl font-extrabold text-foreground tracking-tight mb-8">
          ...
          <div className="prose prose-lg max-w-none text-foreground">
            ...
            <h2 className="mt-6 mb-4 font-bold text-xl">Interpretation and Definitions</h2>
            <p>
            ...
            <h2 className="mt-6 mb-4 font-bold text-xl">Acknowledgement</h2>
            <p>
            ...
            <h2 className="mt-6 mb-4 font-bold text-xl">User Accounts</h2>
            <p>
            ...
            <h2 className="mt-6 mb-4 font-bold text-xl">Limitation of Liability</h2>
            <p>
            ...
            <h2 className="mt-6 mb-4 font-bold text-xl">"As Is" and "As Available" Disclaimer</h2>
            <p>
